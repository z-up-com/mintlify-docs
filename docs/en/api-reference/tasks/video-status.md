...
description: "Query the status, progress, and result of an asynchronous video generation task."
openapi: "/api-reference/z-up_openapi.json GET /videos/generations/{task_id}"
---
