# Gemini-3.1-Flash Official 图像生成
Source: https://docs.toapis.com/docs/cn/api-reference/images/gemini-3.1-flash-official/generation

POST https://toapis.com/v1/images/generations
使用 Google Gemini 3.1 Flash 官方直连模型生成图像，支持思考模式与极端宽高比
